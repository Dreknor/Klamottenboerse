...
<div class="container-fluid">
            <form action="{{url('Nummern/reservieren')}}" method="post">
                {{csrf_field()}}
                <div class="card">
                    <div class="card-header">
                        Welche Verkäufernummer soll für <b><input type="hidden" name="interessent" value="{{$Interessent->id}}">{{ $Interessent->vorname}} {{ $Interessent->nachname}}</b> reserviert werden?
                    </div>
                    <div class="card-body">
                    ...
                    <div class="card-footer">
                        <button class="btn btn-success" type="submit" name="anlegen" >Reservierung anlegen</button>
                    </div>
                </div>
